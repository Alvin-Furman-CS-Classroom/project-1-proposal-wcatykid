...
This folder contains Claude Code skills for automated feedback on your proposal.
...
- Anytime you want to self-assess

## Note

The review is automated guidance, not official grading. Use it to catch issues early, but the instructor's evaluation is final.
